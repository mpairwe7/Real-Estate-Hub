...
export function Navigation() {
  ...
  const navItems = [
    { href: `/${locale}/dashboard`, label: t("navigation.dashboard"), icon: Home },
    { href: `/${locale}/browse`, label: t("navigation.browse"), icon: Search },
    { href: `/${locale}/properties`, label: t("navigation.myProperties"), icon: Building2 },
    { href: `/${locale}/maintenance`, label: t("navigation.maintenance"), icon: Wrench },
    { href: `/${locale}/payments`, label: t("navigation.payments"), icon: CreditCard },
    { href: `/${locale}/profile`, label: t("navigation.profile"), icon: User },
  ]
      ...
      <div className="container mx-auto px-4">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link href={`/${locale}/properties/add`}>
